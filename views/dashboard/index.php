...
<aside>
    <div id="sidebar"  class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
            ...
            <p class="centered"><a href="profile.html"><img src="<?php echo $_SESSION['userpic']; ?>" class="img-circle" width="60"></a></p>
...
<div class="row mt">
    ...
    <div class="col-md-4 col-sm-4 mb">
        <div class="white-panel pn">
            ...
            <div class="centered">
                <img src="<?php echo URL; ?>public/assets/img/product.png" width="120">
            </div>
        </div>
    </div><!-- /col-md-4 -->
    ...
    <div class="col-md-4 mb">
        ...
        <div class="white-panel pn">
            ...
            <p><img src="<?php echo URL; ?>public/assets/img/ui-zac.jpg" class="img-circle" width="80"></p>
            <p><b>Zac Snider</b></p>
            <div class="row">
                <div class="col-md-6">
...
<div class="col-lg-3 ds">
    ...
    <div class="desc">
        <div class="thumb">
            <img class="img-circle" src="<?php echo URL; ?>public/assets/img/ui-divya.jpg" width="35px" height="35px" align="">
        </div>
        <div class="details">
    ...
    <div class="desc">
        <div class="thumb">
            <img class="img-circle" src="<?php echo URL; ?>public/assets/img/ui-sherman.jpg" width="35px" height="35px" align="">
        </div>
        <div class="details">
    ...
    <div class="desc">
        <div class="thumb">
            <img class="img-circle" src="<?php echo URL; ?>public/assets/img/ui-danro.jpg" width="35px" height="35px" align="">
        </div>
        <div class="details">
    ...
    <div class="desc">
        <div class="thumb">
            <img class="img-circle" src="<?php echo URL; ?>public/assets/img/ui-zac.jpg" width="35px" height="35px" align="">
        </div>
        <div class="details">
    ...
    <div class="desc">
        <div class="thumb">
            <img class="img-circle" src="<?php echo URL; ?>public/assets/img/ui-sam.jpg" width="35px" height="35px" align="">
        </div>
        <div class="details">
...
<script type="text/javascript">
    $(document).ready(function () {
        var unique_id = $.gritter.add({
            ...
            title: 'Welcome to Pageler!',
            // (string | mandatory) the text inside the notification
            text: 'A place to create your pages like you want on our special grid.',
